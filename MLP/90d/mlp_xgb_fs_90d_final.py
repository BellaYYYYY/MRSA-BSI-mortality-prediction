...
features_csv_path = 'output/xgb/XGBoost_outputs_90d/90d_shaprfecv_final/selected_features.csv' 

output_dir = "output/mlp_xgb/mlp_90day/mlp_fs_90d"

model_filename = "mlp_90d_fs_xgb.joblib"
