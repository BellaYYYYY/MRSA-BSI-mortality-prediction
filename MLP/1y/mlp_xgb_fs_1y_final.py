...
features_csv_path = 'output/xgb/XGBoost_outputs_1y/1y_shaprfecv_final/selected_features.csv' 

output_dir = "output/mlp_xgb/mlp_1year/mlp_fs_1y"

model_filename = "mlp_1y_fs_xgb.joblib"
