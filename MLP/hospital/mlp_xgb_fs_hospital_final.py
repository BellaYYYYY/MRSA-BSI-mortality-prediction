...
features_csv_path = 'output/xgb/XGBoost_outputs_hospital/hospital_shaprfecv_final/selected_features.csv' 

output_dir = "output/mlp_xgb/mlp_hospitalay/mlp_fs_hospital"

model_filename = "mlp_hospital_fs_xgb.joblib"
