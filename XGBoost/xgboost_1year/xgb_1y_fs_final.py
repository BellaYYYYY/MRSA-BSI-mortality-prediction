...
output_dir = "output/xgb/XGBoost_outputs_1y/1y_shaprfecv_final"
os.makedirs(output_dir, exist_ok=True)
model_filename = "xgb_shaprfecv_1y.joblib"
...
def load_data():
    train_year = pd.read_csv('datasets/train_test_1y/train_df_1y.csv')
    test_year = pd.read_csv('datasets/train_test_1y/test_df_1y.csv')
...
def perform_feature_selection(X_train, y_train, features, scale_pos_weight):
    with open('output/xgb/XGBoost_outputs_1y/1y_nofs_final/best_trial_params.json', 'r') as f:
