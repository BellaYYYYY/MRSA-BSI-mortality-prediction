...
output_dir = "output/xgb/XGBoost_outputs_hospital/hospital_shaprfecv_final"
os.makedirs(output_dir, exist_ok=True)
model_filename = "xgb_shaprfecv_hospital.joblib"
...
def perform_feature_selection(X_train, y_train, features, scale_pos_weight):
    with open('output/xgb/XGBoost_outputs_hospital/hospital_nofs_final/best_trial_params.json', 'r') as f:
