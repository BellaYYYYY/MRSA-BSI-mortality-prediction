...
output_dir = "output/xgb_work/XGBoost_outputs_1y/1y_fs_final_noweight"
os.makedirs(output_dir, exist_ok=True)
model_filename = "xgb_fs_1y_noweight.joblib"
SEED = 75
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(output_dir, "xgb_1y_fs.log")),
...
if __name__ == "__main__":
    try:
        ...
        logger.info(f"Starting XGBoost 1-year mortality prediction model training on {NUM_GPUS}x GPUs at {start_time}")
