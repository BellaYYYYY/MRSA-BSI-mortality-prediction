...
output_dir = "output_test/xgb_work/XGBoost_outputs_90d/90d_fs_final_noweight"
os.makedirs(output_dir, exist_ok=True)
model_filename = "xgb_fs_90d_noweight.joblib"
SEED = 32
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(output_dir, "xgb_90d_fs.log")),
