...
output_dir = "output/xgb_work/XGBoost_outputs_90d/90d_nofs_final_noweight"
os.makedirs(output_dir, exist_ok=True)
model_filename = "xgb_nofs_90d_noweight.joblib"
SEED = 25
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(output_dir, "xgb_90d_nofs.log")),
