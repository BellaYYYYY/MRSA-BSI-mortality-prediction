...
output_dir = 'SHAP/1y_noweight'
os.makedirs(output_dir, exist_ok=True)

test_data = pd.read_csv('datasets/train_test_202511_80/test.csv')

model_filename = 'all_final_model/xgb_fs/xgb_fs_1y_noweight.joblib'
...
plt.savefig(os.path.join(output_dir, 'shap_1y_xgb.tiff'), bbox_inches='tight', pad_inches=0.3, dpi=300)
plt.close()
...
plt.savefig(os.path.join(output_dir, 'shap_1y_15_xgb.tiff'), bbox_inches='tight', pad_inches=0.3, dpi=300)
plt.close()
