...
output_dir = 'SHAP/28d_noweight'
os.makedirs(output_dir, exist_ok=True)

test_data = pd.read_csv('datasets/train_test_202511_80/test.csv')

model_filename = 'all_final_model/xgb_fs/xgb_fs_28d_noweight.joblib'
...
plt.savefig(os.path.join(output_dir, 'shap_28d_xgb.tiff'), bbox_inches='tight', pad_inches=0.3, dpi=300)
plt.close()
...
plt.savefig(os.path.join(output_dir, 'shap_28d_15_xgb.tiff'), bbox_inches='tight', pad_inches=0.3, dpi=300)
plt.close()
